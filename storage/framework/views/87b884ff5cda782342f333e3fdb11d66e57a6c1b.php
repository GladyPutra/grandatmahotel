    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <!-- main dropdown -->
                <li><a href="<?php echo e(route('dashboard')); ?>"></i>Selamat Datang di Halaman Reservasi </a></li>
                <!-- end main dropdown -->
            </ul>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    <li><a href="<?php echo e(route('reservasinonlogin.reservasi')); ?>"><i class="fa fa-file fa-fw"></i> DATA RESERVASI</a></li>
                    <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-arrow-left fa-fw"></i> BATAL</a></li>
                </ul>
                <!-- end side-menu -->
            </div>
