    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-6">
                    <?php echo Form::open(['method'=>'GET','route'=>'filterlaporan.LaporanPendapatanPerJenisTamu']); ?>
                        ...
                        <table class="table table-striped table-bordered" id="dataTables-example">
                            ...
                            <?php $__currentLoopData = $laporan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td align="right"><?php echo e(number_format($data->JUMLAH_TARIF, 2, ',', '.')); ?></td>
                                    <td><?php echo e($data->detilreservasi['JENIS_TAMU']); ?></td>
