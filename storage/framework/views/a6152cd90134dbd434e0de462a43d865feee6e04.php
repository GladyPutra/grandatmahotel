        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-sm-4 col-xs-8 form-group">
                    <a href="<?php echo e(route('customer.datareservasi')); ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>
                </div>
                ...
                <?php if($reservasi->count()): ?>
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="<?php echo e(route('customer.hapushistorireservasi', $data->ID_BOOKING)); ?>" accept-charset="UTF-8">
