        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-sm-4 col-xs-8 form-group">
                    <a href="<?php echo e(route('customer.kamar')); ?>" class="btn btn-success"><i class="fa fa-refresh"></i> Refresh</a>
                </div>
                <?php echo Form::open(['method'=>'GET','route'=>'customer.carikamar']); ?>
                ...
                <?php if($kamar->count()): ?>
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('customer.detilkamar',$data->ID_KAMAR)); ?>" class="btn btn-default btn-xs"><i class="fa fa-info-circle"></i> Detil</a>
                            </td>
                        </tr>
                        </tbody>
